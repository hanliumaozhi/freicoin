...
How To Example for Bitcoin / Freicoin
=====================================

This example assumes bitcoin RPC port is 8332 and freicoin is at port 8638.

Compile freicoind and bitcoind with the merged mining patch.  Then run:

  `contrib/merged-mine-proxy -w 8630 -p http://pw:un@127.0.0.1:8332/ -x http://pw:un@127.0.0.1:8638/`

This will have the proxy listen at port 8630.  

Point your miner at 127.0.0.1 port 8630 and start mining.
